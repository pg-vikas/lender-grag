            ...
            {features.map((f, i) => (
              ...
              >
                ...
                <div className="relative flex items-start justify-between mb-5">
                  <motion.div
                    className="w-12 h-12 rounded-xl bg-white/[0.06] border border-white/[0.08] flex items-center justify-center group-hover:bg-[#d4a94c]/15 group-hover:border-[#d4a94c]/25 transition-all duration-400"
                    whileHover={{ rotate: 8 }}
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <f.icon className="w-[22px] h-[22px] text-white/50 group-hover:text-[#d4a94c] transition-colors duration-400" />
                  </motion.div>
                  <span className="text-[42px] font-extrabold text-white/[0.04] leading-none group-hover:text-white/[0.08] transition-colors duration-400 select-none">{f.num}</span>
                </div>
                <h3 className="text-[17px] font-bold text-white mb-2 relative group-hover:text-[#f0d88a] transition-colors duration-400">{f.title}</h3>
                <p className="text-[14px] text-white/35 leading-relaxed relative group-hover:text-white/55 transition-colors duration-400">{f.desc}</p>

                <motion.div
                  className="mt-4 flex items-center gap-1.5 text-[13px] font-semibold text-white/20 group-hover:text-[#d4a94c] transition-colors duration-400 relative"
                  initial={false}
                >
