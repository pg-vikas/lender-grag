  ...
  return (
    <section className="relative w-full">
      <div className="relative flex flex-col">
        <div className="relative w-full min-h-screen snap-start snap-always flex items-center bg-[linear-gradient(180deg,rgba(201,245,200,1)_0%,rgba(151,194,149,1)_100%)] overflow-hidden">
        ...
        <div className="relative w-full min-h-screen snap-start snap-always flex flex-col items-center justify-center">
        ...
        <div className="relative w-full flex flex-col items-center justify-center min-h-screen snap-start snap-always bg-[#ffffff]">
